...
public interface ITradeV3Client {
	...
	/**
	 * This interface is currently supported only for Webull HK, Webull US, Webull SG, Webull TH, Webull AU, Webull MY, Webull UK, Webull JP, Webull BR, and Webull MX.
