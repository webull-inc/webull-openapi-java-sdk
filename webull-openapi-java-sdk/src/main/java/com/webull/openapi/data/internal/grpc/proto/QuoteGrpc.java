package com.webull.openapi.data.internal.grpc.proto;
...
public final class QuoteGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.webull.openapi.data.internal.grpc.proto.Gateway.ClientRequest,
      com.webull.openapi.data.internal.grpc.proto.Gateway.ClientResponse> getStreamRequestMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StreamRequest",
      requestType = com.webull.openapi.data.internal.grpc.proto.Gateway.ClientRequest.class,
      responseType = com.webull.openapi.data.internal.grpc.proto.Gateway.ClientResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.webull.openapi.data.internal.grpc.proto.Gateway.ClientRequest,
      com.webull.openapi.data.internal.grpc.proto.Gateway.ClientResponse> getStreamRequestMethod() {
    io.grpc.MethodDescriptor<com.webull.openapi.data.internal.grpc.proto.Gateway.ClientRequest, com.webull.openapi.data.internal.grpc.proto.Gateway.ClientResponse> getStreamRequestMethod;
      ...
      synchronized (QuoteGrpc.class) {
        if ((getStreamRequestMethod = QuoteGrpc.getStreamRequestMethod) == null) {
          QuoteGrpc.getStreamRequestMethod = getStreamRequestMethod =
              io.grpc.MethodDescriptor.<com.webull.openapi.data.internal.grpc.proto.Gateway.ClientRequest, com.webull.openapi.data.internal.grpc.proto.Gateway.ClientResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "StreamRequest"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.webull.openapi.data.internal.grpc.proto.Gateway.ClientRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.webull.openapi.data.internal.grpc.proto.Gateway.ClientResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.webull.openapi.data.internal.grpc.proto.Gateway.ClientRequest,
      com.webull.openapi.data.internal.grpc.proto.Gateway.ClientResponse> getRequestMethod;
  ...
  public static io.grpc.MethodDescriptor<com.webull.openapi.data.internal.grpc.proto.Gateway.ClientRequest,
      com.webull.openapi.data.internal.grpc.proto.Gateway.ClientResponse> getRequestMethod() {
    io.grpc.MethodDescriptor<com.webull.openapi.data.internal.grpc.proto.Gateway.ClientRequest, com.webull.openapi.data.internal.grpc.proto.Gateway.ClientResponse> getRequestMethod;
  ...
  public static abstract class QuoteImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.webull.openapi.data.internal.grpc.proto.Gateway.ClientRequest> streamRequest(
        io.grpc.stub.StreamObserver<com.webull.openapi.data.internal.grpc.proto.Gateway.ClientResponse> responseObserver) {
      return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(getStreamRequestMethod(), responseObserver);
    }

    /**
     */
    public void request(com.webull.openapi.data.internal.grpc.proto.Gateway.ClientRequest request,
        io.grpc.stub.StreamObserver<com.webull.openapi.data.internal.grpc.proto.Gateway.ClientResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                com.webull.openapi.data.internal.grpc.proto.Gateway.ClientRequest,
                com.webull.openapi.data.internal.grpc.proto.Gateway.ClientResponse>(
  ...
  public static final class QuoteBlockingStub extends io.grpc.stub.AbstractBlockingStub<QuoteBlockingStub> {
    ...
    /**
     */
    public com.webull.openapi.data.internal.grpc.proto.Gateway.ClientResponse request(com.webull.openapi.data.internal.grpc.proto.Gateway.ClientRequest request) {
  ...
  public static final class QuoteFutureStub extends io.grpc.stub.AbstractFutureStub<QuoteFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.webull.openapi.data.internal.grpc.proto.Gateway.ClientResponse> request(
        com.webull.openapi.data.internal.grpc.proto.Gateway.ClientRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REQUEST:
          serviceImpl.request((com.webull.openapi.data.internal.grpc.proto.Gateway.ClientRequest) request,
              (io.grpc.stub.StreamObserver<com.webull.openapi.data.internal.grpc.proto.Gateway.ClientResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class QuoteBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.webull.openapi.data.internal.grpc.proto.Gateway.getDescriptor();
    }
